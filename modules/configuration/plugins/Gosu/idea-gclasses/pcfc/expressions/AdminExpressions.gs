...
class AdminExpressions {
  ...
  public static class AdminExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function canVisit_82 (affinityGroup :  AffinityGroup, group :  Group, org :  Organization) : java.lang.Boolean {
    ...
    static function firstVisitableChildDestinationMethod_89 (affinityGroup :  AffinityGroup, group :  Group, org :  Organization) : pcf.api.Destination {
    ...
    function menuActions_onEnter_83 (def :  pcf.AdminMenuActions) : void {
      def.onEnter()
    }
    
    // 'menuActions' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 71
    function menuActions_refreshVariables_84 (def :  pcf.AdminMenuActions) : void {
      def.refreshVariables()
    }
    
    // 'menuTree' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 71
    function menuTree_onEnter_85 (def :  pcf.AdminMenuTree) : void {
      def.onEnter(treeModel, org, group)
    }
    
    // 'menuTree' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 71
    function menuTree_refreshVariables_86 (def :  pcf.AdminMenuTree) : void {
