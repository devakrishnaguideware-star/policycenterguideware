...
class ScheduleInputSet_trueExpressions {
  ...
  public static class IteratorEntry3ExpressionsImpl extends ListViewPanelExpressionsImpl {
    ...
    function value_33 () : gw.api.productmodel.SchedulePropertyInfo<java.lang.Object>[] {
      return propertyInfos
    }
    
    // 'value' attribute on CellIterator (id=CovTermValues) at ScheduleInputSet.true.pcf: line 108, column 84
    function value_51 () : java.util.List<gw.api.productmodel.CovTermPattern> {
  ...
  public static class IteratorEntry4ExpressionsImpl extends IteratorEntry3ExpressionsImpl {
    ...
    function def_onEnter_17 (def :  pcf.ScheduledItemColumnInput_AutoNumber) : void {
      def.onEnter(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_onEnter_19 (def :  pcf.ScheduledItemColumnInput_Boolean) : void {
      def.onEnter(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_onEnter_21 (def :  pcf.ScheduledItemColumnInput_Date) : void {
      def.onEnter(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_onEnter_23 (def :  pcf.ScheduledItemColumnInput_ForeignKey) : void {
      def.onEnter(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_onEnter_25 (def :  pcf.ScheduledItemColumnInput_Integer) : void {
      def.onEnter(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_onEnter_27 (def :  pcf.ScheduledItemColumnInput_String) : void {
      def.onEnter(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_onEnter_29 (def :  pcf.ScheduledItemColumnInput_TypeKey) : void {
      def.onEnter(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_refreshVariables_18 (def :  pcf.ScheduledItemColumnInput_AutoNumber) : void {
      def.refreshVariables(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_refreshVariables_20 (def :  pcf.ScheduledItemColumnInput_Boolean) : void {
      def.refreshVariables(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_refreshVariables_22 (def :  pcf.ScheduledItemColumnInput_Date) : void {
      def.refreshVariables(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_refreshVariables_24 (def :  pcf.ScheduledItemColumnInput_ForeignKey) : void {
      def.refreshVariables(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_refreshVariables_26 (def :  pcf.ScheduledItemColumnInput_Integer) : void {
      def.refreshVariables(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_refreshVariables_28 (def :  pcf.ScheduledItemColumnInput_String) : void {
      def.refreshVariables(propertyInfo, scheduledItem)
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 102, column 51
    function def_refreshVariables_30 (def :  pcf.ScheduledItemColumnInput_TypeKey) : void {
      def.refreshVariables(propertyInfo, scheduledItem)
    }
  ...
  public static class IteratorEntry5ExpressionsImpl extends IteratorEntry3ExpressionsImpl {
    ...
    function def_onEnter_35 (def :  pcf.ScheduledItemCovTermInput_Direct) : void {
      def.onEnter(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_onEnter_37 (def :  pcf.ScheduledItemCovTermInput_Option) : void {
      def.onEnter(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_onEnter_39 (def :  pcf.ScheduledItemCovTermInput_Package) : void {
      def.onEnter(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_onEnter_41 (def :  pcf.ScheduledItemCovTermInput_Typekey) : void {
      def.onEnter(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_onEnter_43 (def :  pcf.ScheduledItemCovTermInput_bit) : void {
      def.onEnter(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_onEnter_45 (def :  pcf.ScheduledItemCovTermInput_shorttext) : void {
      def.onEnter(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_refreshVariables_36 (def :  pcf.ScheduledItemCovTermInput_Direct) : void {
      def.refreshVariables(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_refreshVariables_38 (def :  pcf.ScheduledItemCovTermInput_Option) : void {
      def.refreshVariables(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_refreshVariables_40 (def :  pcf.ScheduledItemCovTermInput_Package) : void {
      def.refreshVariables(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_refreshVariables_42 (def :  pcf.ScheduledItemCovTermInput_Typekey) : void {
      def.refreshVariables(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_refreshVariables_44 (def :  pcf.ScheduledItemCovTermInput_bit) : void {
      def.refreshVariables(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_refreshVariables_46 (def :  pcf.ScheduledItemCovTermInput_shorttext) : void {
      def.refreshVariables(scheduledItem.getCovTerm(covTermPattern))
    }
  ...
  public static class ListViewPanelExpressionsImpl extends ScheduleInputSetExpressionsImpl {
    ...
    function toCreateAndAdd_52 () : entity.ScheduledItem {
    ...
    function toRemove_53 (scheduledItem :  entity.ScheduledItem) : void {
    ...
    function value_54 () : entity.ScheduledItem[] {
